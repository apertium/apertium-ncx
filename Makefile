...
pkgdatadir = $(datadir)/apertium-ncx
pkgincludedir = $(includedir)/apertium-ncx
pkglibdir = $(libdir)/apertium-ncx
pkglibexecdir = $(libexecdir)/apertium-ncx
...
CONFIG_CLEAN_FILES = apertium-ncx.pc
...
am__installdirs = "$(DESTDIR)$(apertium_ncxdir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_ncx_DATA) $(noinst_DATA) $(pkgconfig_DATA)
am__tagged_files = $(HEADERS) $(SOURCES) $(TAGS_FILES) $(LISP)
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/apertium-ncx.pc.in \
...
ACLOCAL = ${SHELL} /home/fran/source/apertium/languages/apertium-ncx/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
AUTOCONF = ${SHELL} /home/fran/source/apertium/languages/apertium-ncx/missing autoconf
AUTOHEADER = ${SHELL} /home/fran/source/apertium/languages/apertium-ncx/missing autoheader
AUTOMAKE = ${SHELL} /home/fran/source/apertium/languages/apertium-ncx/missing automake-1.15
AWK = gawk
CG3_CFLAGS = -I/home/fran/local/include/
CG3_LIBS = -L/home/fran/local/lib -lcg3
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ Central\ Puebla\ Nahuatl\" -DPACKAGE_TARNAME=\"apertium-ncx\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ Central\ Puebla\ Nahuatl\ 0.1.0\" -DPACKAGE_BUGREPORT=\"https://github.com/apertium/apertium-ncx/issues\" -DPACKAGE_URL=\"https://wiki.apertium.org/wiki/Apertium-ncx\" -DPACKAGE=\"apertium-ncx\" -DVERSION=\"0.1.0\"
ECHO_C = 
ECHO_N = -n
ECHO_T = 
HFSTOSPELL_CFLAGS = 
...
MAKEINFO = ${SHELL} /home/fran/source/apertium/languages/apertium-ncx/missing makeinfo
MKDIR_P = /bin/mkdir -p
PACKAGE = apertium-ncx
PACKAGE_BUGREPORT = https://github.com/apertium/apertium-ncx/issues
PACKAGE_NAME = Apertium Central Puebla Nahuatl
PACKAGE_STRING = Apertium Central Puebla Nahuatl 0.1.0
PACKAGE_TARNAME = apertium-ncx
PACKAGE_URL = https://wiki.apertium.org/wiki/Apertium-ncx
...
STRIP = 
VERSION = 0.1.0
abs_builddir = /home/fran/source/apertium/languages/apertium-ncx
abs_srcdir = /home/fran/source/apertium/languages/apertium-ncx
abs_top_builddir = /home/fran/source/apertium/languages/apertium-ncx
abs_top_srcdir = /home/fran/source/apertium/languages/apertium-ncx
am__leading_dot = .
...
install_sh = ${SHELL} /home/fran/source/apertium/languages/apertium-ncx/install-sh
...
###############################################################################
#
#   apertium_ncx_dir: This is where the compiled binaries go
#   apertium_ncx_srcdir: This is where the source files go
apertium_ncxdir = $(prefix)/share/apertium/$(BASENAME)/
apertium_ncx_srcdir = $(prefix)/share/apertium/$(BASENAME)/
apertium_ncx_DATA = $(TARGETS_COMMON) \
	$(BASENAME).$(LANG1).lexc	\
	$(BASENAME).$(LANG1).twol	\
	$(BASENAME).$(LANG1).rlx	\
	$(BASENAME).post-$(LANG1).dix	\
...
$(am__aclocal_m4_deps):
apertium-ncx.pc: $(top_builddir)/config.status $(srcdir)/apertium-ncx.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_ncxDATA: $(apertium_ncx_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_ncx_DATA)'; test -n "$(apertium_ncxdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_ncxdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_ncxdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_ncxdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_ncxdir)" || exit $$?; \
	done

uninstall-apertium_ncxDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_ncx_DATA)'; test -n "$(apertium_ncxdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_ncxdir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_ncxdir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_ncxDATA install-data-local \
...
uninstall-am: uninstall-apertium_ncxDATA uninstall-local \
	uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_ncxDATA install-data \
...
.deps/$(LANG1).automorf.hfst: .deps/$(LANG1).LR.hfst .deps/$(LANG1).spellrelax.hfst
	hfst-compose -F -1 $< -2 .deps/$(LANG1).spellrelax.hfst | hfst-invert -o $@

$(LANG1).automorf.hfst: .deps/$(LANG1).automorf.hfst
	 hfst-fst2fst -O .deps/$(LANG1).automorf.hfst -o $@
